...
**NEXT:** the **fundamentals** data flow (same template pattern) → the Gemini free-text engine; tighten `pt14` from `scoring.py`; fold `src/pat/` into the deploy. (RS-leaders flow shipped same session — see D55 Phase 1c.)
