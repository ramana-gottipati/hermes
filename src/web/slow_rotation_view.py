...
def slow_rotation_page(fmt: str = ""):
    ...
    body = (
        ...
        "THIS form survived a realistic participation-cost model: <b>net Sharpe ~1.02 at ₹50cr</b>, "
        "beating the index net up to a capacity ceiling of roughly ₹100–150cr "
        "(<code>docs/strategy-ledger.md</code> §§ 2026-06-24 / 07-02 / 07-05c). Flat-cost headline "
