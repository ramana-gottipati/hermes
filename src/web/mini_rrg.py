...
def mini_rrg_card(full_tail, den: str = "Nifty 500", *, tail_label: str = "",
    ...
    p.append(f'<text x="{L + 4}" y="{T + 10}" fill="#6e7681" font-size="7">improving</text>')
    p.append(f'<text x="{R - 4}" y="{T + 10}" fill="#6e7681" font-size="7" text-anchor="end">leading</text>')
    p.append(f'<text x="{R - 4}" y="{B - 4}" fill="#6e7681" font-size="7" text-anchor="end">weakening</text>')
    p.append(f'<text x="{L + 4}" y="{B - 4}" fill="#6e7681" font-size="7">lagging</text>')
