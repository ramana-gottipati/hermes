...
def model_portfolios_page(p: str = "STEADY-25", asof: str = "", fmt: str = "",
    ...
    body = (
        ...
        + ("<div style='margin:14px 0;padding:10px 12px;border:1px solid #d29922;"
           ...
           "<h3 style='margin:0 0 4px'>🎓 Graduating candidates — the Union family (Tier C), not yet investable</h3>"
           "<p style='font-size:.85em;color:#8b97a7;margin:.3em 0'>The estate's highest-potential books are the "
           "<b>seven sealed siblings</b> of the \"union\" momentum-selection family — all <b>sealed and forward-testing</b>. "
           "NONE funds real money until the pre-registered <b>2026-10-03 forward test</b>, and the family's frozen rule "
           "<b>graduates at most ONE</b> among any that pass. Forward expectations are <b>modest and deflation-adjusted</b> — "
           "the eye-catching 26%+ in-sample CAGRs are selection-inflated, not promises. ⚠ Capacity is <b>UNVERIFIED</b> "
           "(early-era small/mid-cap tilt) — likely personal-scale only.</p>"
           "<table style='font-size:.82em;border-collapse:collapse;margin:.4em 0'>"
           "<thead><tr style='text-align:left;color:#8b97a7'><th style='padding:2px 12px 2px 0'>Sibling</th>"
           "<th style='padding:2px 12px 2px 0'>What it adds</th><th style='padding:2px 12px 2px 0'>Honest forward</th>"
           "<th style='padding:2px 0'>Worst drop</th></tr></thead><tbody>"
           "<tr><td style='padding:2px 12px 2px 0'>Union</td><td style='padding:2px 12px 2px 0'>RS turn ∪ RS trend, top-60</td><td style='padding:2px 12px 2px 0'>~15.7%</td><td style='padding:2px 0'>−38%</td></tr>"
           "<tr><td style='padding:2px 12px 2px 0'>β14</td><td style='padding:2px 12px 2px 0'>+ trailing-beta ≤ 1.4</td><td style='padding:2px 12px 2px 0'>~16.6%</td><td style='padding:2px 0'>−28%</td></tr>"
           "<tr><td style='padding:2px 12px 2px 0'>C40RA</td><td style='padding:2px 12px 2px 0'>+ risk-adjusted rank, top-40</td><td style='padding:2px 12px 2px 0'>~18.1%</td><td style='padding:2px 0'>−33%</td></tr>"
           "<tr><td style='padding:2px 12px 2px 0'>A2</td><td style='padding:2px 12px 2px 0'>+ era-floor (lower-drawdown)</td><td style='padding:2px 12px 2px 0'>~21.0%</td><td style='padding:2px 0'>−33%</td></tr>"
           "<tr><td style='padding:2px 12px 2px 0'><b>COMPOSITE-30</b> (lead)</td><td style='padding:2px 12px 2px 0'>+ top-30 + let-winners-run</td><td style='padding:2px 12px 2px 0'><b>~21.6%</b></td><td style='padding:2px 0'>−38%</td></tr>"
           "<tr><td style='padding:2px 12px 2px 0'>K30-HOLD</td><td style='padding:2px 12px 2px 0'>+ hold winners longer</td><td style='padding:2px 12px 2px 0'>owed*</td><td style='padding:2px 0'>−38%</td></tr>"
           "<tr><td style='padding:2px 12px 2px 0'>A2-HOLD</td><td style='padding:2px 12px 2px 0'>equal-weight lower-drawdown cousin</td><td style='padding:2px 12px 2px 0'>owed*</td><td style='padding:2px 0'>−33%</td></tr>"
           "<tr><td style='padding:2px 12px 2px 0'><b>K30-DEEP-HOLD</b></td><td style='padding:2px 12px 2px 0'>+ deeper-turn (best net &amp; drop)</td><td style='padding:2px 12px 2px 0'>owed*</td><td style='padding:2px 0'><b>−29%</b></td></tr>"
           "</tbody></table>"
           "<p style='font-size:.8em;color:#8b97a7;margin:.3em 0'>* the three HOLD/DEEP variants (added 2026-07-22) improve the "
           "in-sample net-of-cost (19.0 / 18.6 / 19.2%) and K30-DEEP-HOLD cuts the worst drop to −29%; their deflation-adjusted "
           "forward is not yet computed — expect a similar haircut to their parents, and K30-DEEP-HOLD carries the highest "
