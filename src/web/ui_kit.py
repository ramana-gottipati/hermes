...
def cmdk_overlay() -> str:
    ...
    return (
        ...
        'var PAGES={markets:"/dash/markets",screener:"/dash/screener",strategies:"/dash/strategies",'
        ...
        'screen:"/dash/screener",watchlists:"/dash/watchlists",portfolios:"/dash/portfolios",'
        ...
        'if(a&&a.id==="cmdk-in"){var q=a.value.trim();if(q)location.href=route(q);}}});'
