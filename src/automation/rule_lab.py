...
_BLOCKING_JSON = r"""
{
 ...
 "rows": {
  "ACCEL_PULLBACK_DELIV": "| ACCEL / PULLBACK / DELIV_MOM (standalone) | Sharpe 0.42-0.85, MaxDD \u221244%\u2026\u221270% | Short-thrust chasing / dip-buying / delivery% added no standalone edge. |",
  "BOOK_YIELD": "| **BOOK_YIELD (deep value / B-P)** | Sharpe 0.61-0.63 \u00b7 **alpha \u22121.8%\u2026\u22122.2% (NEGATIVE)** \u00b7 **beta 1.54-1.56** \u00b7 **MaxDD \u221282%** \u00b7 fails BOTH halves | Negative alpha + \u221282% drawdown + high beta = a value-trap engine. **Never a production long-ranker.** The \u03b2\u22481.54 + MaxDD\u224882% alone stop us. |",
  ...
  "EARN_YIELD": "| **EARN_YIELD (cheap on P/E)** | Sharpe 0.70 \u00b7 alpha +0.4% \u00b7 MaxDD \u221271% | No index-beating edge standalone; deep drawdown. |",
  ...
  "MOMENTUM_FUNDABLE": "| **Momentum sold as a FUNDABLE strategy** | GROSS Sharpe 1.29 \u2192 **NET ~0.09, CAGR negative, MaxDD \u221269%** under realistic cost (~36%/yr, ~100%/mo turnover) | The headline Sharpe is a flat-cost illusion. Nothing beats Nifty-500 buy-&-hold (0.89) net of realistic cost. Momentum = a **gross selection/analytical lens**, not net alpha; any fundable form must be low-turnover (and is then defensive, not alpha). |",
  ...
  "QUALITY_STANDALONE": "| **QUALITY standalone** | Sharpe 0.76 \u00b7 alpha ~0.0% \u00b7 fails halves | Quality doesn't rank returns alone; only helps *attached to momentum* (QUAL_MOM). \u2192 C is a veto/filter, not a ranker. |"
 },
