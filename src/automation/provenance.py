...
PROVENANCE: dict[str, ProvenanceDescriptor] = {
    ...
    "fundamentals_history": _d("fundamentals_history", "Historical financial time-series",
                               "Screener.in scrape (legacy, source IS NULL) + NSE XBRL results (source=NSE-XBRL-*, 2026-07→)",
                               "research",
                               ...
                               cadence="quarterly (modelled legacy; XBRL rows carry the real broadcast)"),
