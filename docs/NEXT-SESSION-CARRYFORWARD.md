...
- **Remaining S-A deltas (small):** humanize the home Attention event strings (deferred — `attention_view.py` was hot mid-flight; now free) · strategy-ref public intro is S-C's · P0-5 strategy-ref leak untouched (S-C). Live walk verified every shipped item (curl transcript in session).
