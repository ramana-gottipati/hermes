...
## ⚠ 2026-07-22 — union_forward.py: the 7-sibling WIRING is CODE-COMPLETE (committed) but BOX-DEPLOY is BLOCKED by a PRE-EXISTING era-floor anchor drift — the deployed runner is RED at its own reproduction gate; re-anchor (16AS loop) needed first — do NOT redo the wiring; kickstart-pick-verify
