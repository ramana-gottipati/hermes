...
- **DEPLOYED + verified (union_forward.py md5 `7dcb6383`, box == repo):** all 6 gate rows OK; §1b reproduces K30-HOLD 27.2% · A2-HOLD 26.6% · K30-DEEP-HOLD 27.5% (recorded, to the decimal); §3b sibling forward-criteria self-suppress at 0 quarters (fire Oct-3+). The Oct-3 runner now grades all SEVEN siblings mechanically.
