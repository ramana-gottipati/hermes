...
| M4 stock hub | **UNBLOCKED for RE-PLANNING** (Parts II–IV ratified in full, 2026-07-20) — spec for owner review precedes any build | Part II §A archetype + §C/§D contracts, Part III §I/§J, and Part IV §L–§O (type-contracts + comparison contract + dense-rail spec + gap list) are its inputs |
