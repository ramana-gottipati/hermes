...
| M4 stock hub | **UNBLOCKED for RE-PLANNING** (contracts ratified 2026-07-20) — spec for owner review precedes any build | Part II §A archetype + §C/§D contracts + Part IV §O gap list are its inputs |
