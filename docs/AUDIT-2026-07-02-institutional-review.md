...
**AUD-01 [P0] Public HTTP surface unauthenticated and unfirewalled (dashboard, /chat, /conversations)** — `OPEN`
...
**AUD-02 [P0] No off-box backup of the only copy of the 16GB production DB** — `OPEN`
...
**AUD-04 [P0] Trust front-door /dash/coverage: 4.1s every request, 29–38s under 6-way concurrency (+ memo, + /v1 coverage/health share the fix)** — `OPEN`
...
**AUD-34 [P1] SSH permits root password login with no fail2ban** — `OPEN`
