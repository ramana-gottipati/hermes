...
> **Status:** **DESCRIPTIVE-ONLY** (the two-tier engine + surfaces are LIVE and compute nightly, but the original *leading smart-money picker* thesis was empirically **refuted** — DVPT is a within-stock confirmation/character lens, never a cross-stock alpha ranker). · **Governing decision(s):** D62 (the reframe) · D28/D31/D43/D44 (the live engine) · D56 (refutation) · D107 (number integrity) · D47 (deep-history data) · **Reconciled:** 2026-07-11 (S109).
