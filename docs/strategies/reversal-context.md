...
- **Confirmation craft (07-14, FRACTAL FLOOR).** The up-fractal breakout confirmation adds **≈ nothing** over mere floor proximity at fixed horizons; "STRONG" (beats the first two up-fractals) is *worse*. The floor is the information; the breakout craft is not. *(The interim "PROX10 book Sharpe 1.04" was a **gross-of-cost accounting defect** — see next.)*
